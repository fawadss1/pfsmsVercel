$.fn.pcodedmenu = function (settings) {
    ...
    var defaults = {
        ...
        ActiveItemBackground: 'theme1', // Value should be theme1/theme2/theme3/theme4/theme5/theme6/theme7/theme8/theme9
        ...
        HandleThemeBackground: function () {
            ...
            function setlheadertheme() {
                ...
                if (ev != undefined && ev != "") {
                    ...
                    $('#' + oid + ' .pcoded-header .navbar-logo').attr("logo-theme", "theme1");
