...
!function (t) {
    ...
    var i = e.SET_A = 0, a = e.SET_B = 1, u = e.SET_C = 2, s = (e.SHIFT = 98, e.START_A = 103), f = e.START_B = 104,
        c = e.START_C = 105;
    e.MODULO = 103, e.STOP = 106, e.FNC1 = 207, e.SET_BY_CODE = (o(r = {}, s, i), o(r, f, a), o(r, c, u), r), e.SWAP = {
        101: i,
        100: a,
        99: u
    ...
    }(), i = n(11), a = (r = i) && r.__esModule ? r : {default: r}, u = n(0);
    var s = function (t) {
        function e(t, n) {
            !function (t, e) {
    ...
    e.getMaximumHeightOfEncodings = function (t) {
        ...
        for (var r = 0; r < t.length; r++) {
            var o, f = t[r], c = (0, i.default)(e, f.options);
    ...
    "use strict";
    var r = d(n(8)), o = d(n(2)), i = d(n(16)), a = d(n(17)), u = d(n(18)), s = d(n(3)), f = d(n(24)), c = n(6),
        l = d(n(4));
    ...
    for (var v in h.getModule = function (t) {
        return r.default[t]
    }, r.default) r.default.hasOwnProperty(v) && g(r.default, v);
    ...
    p.prototype.options = function (t) {
        ...
        if (Array.isArray(this._renderProperties)) for (var t = 0; t < this._renderProperties.length; t++) _(this._renderProperties[t], this._encodings, this._options); else _(this._renderProperties, this._encodings, this._options);
        return this
    ...
    var r = u(n(10)), o = u(n(13)), i = u(n(14)), a = u(n(15));
    ...
    e.default = function (t) {
        var e = void 0;
        if (a(t).length >= 2) e = r.C_START_CHAR + s(t); else {
            var n = o(t) > i(t);
    ...
    }(), i = n(1), a = (r = i) && r.__esModule ? r : {default: r}, u = n(0);
    var s = function (t) {
        function e(t, n) {
            return function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    var r = a(n(21)), o = a(n(22)), i = a(n(23));
    ...
    }(), i = n(2), a = (r = i) && r.__esModule ? r : {default: r}, u = n(5);
    var s = function () {
        function t(e, n, r) {
            !function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
    ...
    var s = "http://www.w3.org/2000/svg", f = function () {
        function t(e, n, r) {
            !function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
